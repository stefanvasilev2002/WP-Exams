...
public class VirtualServerController {
    ...
    public VirtualServerController(VirtualServerService service, UserService userService) {
        this.virtualServerService = service;
    ...
    public String showList(@RequestParam(required = false) Integer activeMoreThanDays,
        ...
        if (ownerId == null && activeMoreThanDays == null) {
            virtualServers = this.virtualServerService.listAll();
        } else {
            virtualServers = this.virtualServerService.filter(ownerId, activeMoreThanDays);
        }
     ...
     */
    @GetMapping(value = "/VirtualServers/add")
    public String showAdd(Model model) {
        model.addAttribute("server", new VirtualServer());
     ...
     * @return The view "form.html".
     */
    @GetMapping(value = "/VirtualServers/{id}/edit")
    public String showEdit(@PathVariable Long id,
                           Model model) {
        model.addAttribute("server", virtualServerService.findById(id));
        model.addAttribute("osTypes", OSType.values());
        model.addAttribute("owners", userService.listAll());
        return "form";
    }
     ...
     * @return The view "list.html".
     */
    @PostMapping(value = "/VirtualServers")
    public String create(@RequestParam String instanceName,
        ...
        this.virtualServerService.create(instanceName, ipAddress, osType, owners, launchDate);
     ...
     * @return The view "list.html".
     */
    @PostMapping(value = "/VirtualServers/{id}")
    public String update(@PathVariable Long id,
                         @RequestParam String instanceName,
                         @RequestParam String ipAddress,
                         @RequestParam OSType osType,
                         @RequestParam List<Long> owners) {
        this.virtualServerService.update(id, instanceName, ipAddress, osType, owners);
        return "redirect:/VirtualServers";
    }
     ...
     * @return The view "list.html".
     */
    @PostMapping(value = "/VirtualServers/{id}/delete")
    public String delete(@PathVariable Long id) {
        this.virtualServerService.delete(id);
        return "redirect:/VirtualServers";
    }
     ...
     * @return The view "list.html".
     */
    @PostMapping(value = "/VirtualServers/{id}/terminate")
    public String terminate(@PathVariable Long id) {
        this.virtualServerService.markTerminated(id);
        return "redirect:/VirtualServers";
    }
}
